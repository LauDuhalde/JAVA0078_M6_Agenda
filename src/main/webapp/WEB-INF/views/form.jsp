...
<div class="container my-5">
    ...
    <c:if test="${fn:length(evento.titulo) > 50}">
        <div class="alert alert-warning mt-3">El t�tulo es demasiado largo (m�x. 50 caracteres).</div>
    </c:if>

    <c:if test="${fn:length(evento.descripcion) > 200}">
        <div class="alert alert-warning mt-3">La descripci�n es demasiado larga (m�x. 200 caracteres).</div>
    </c:if>
</div>
