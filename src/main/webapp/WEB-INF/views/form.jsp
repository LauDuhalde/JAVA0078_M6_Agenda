...
<div class="container my-5">
    ...
    <c:if test="${fn:length(evento.titulo) > 50}">
        <div class="alert alert-warning mt-3">El titulo es demasiado largo (max. 50 caracteres).</div>
    </c:if>

    <c:if test="${fn:length(evento.descripcion) > 200}">
        <div class="alert alert-warning mt-3">La descripcion es demasiado larga (max. 200 caracteres).</div>
    </c:if>
</div>
